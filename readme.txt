Characters can be displayed in the air using M5StickC and LED tape. 
Transfer the character data created by the iPhone application (OshiBou) to the M5StickC for use. 
Use the iPhone app OshiBou to create and transfer display data for M5StickC. 
...
2. Unzip oshibou.ino.m5stick_c.zip 
...
4. Enter characters in the iPhone app and press MAKE DOT button 
